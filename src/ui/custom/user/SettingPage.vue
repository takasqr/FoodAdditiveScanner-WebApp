...
import SettingForm from '@/ui/custom/user/SettingForm.vue';
import NewPasswordArea from '@/ui/custom/auth/NewPasswordArea.vue';
import DeleteAccountArea from '@/ui/custom/auth/DeleteAccountArea.vue';
